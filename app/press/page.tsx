...
import { ExternalLinkIcon, MailIcon, MoonIcon, SunIcon, socialLinks } from "../components/icons";
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <section id="logos" className="mb-16 scroll-mt-28">
              ...
              <div className="mt-8 p-6 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
